...
import static com.phone.sip.SipApplication.getHeadersForPush;
import static com.phone.sip.SipApplication.getHeadersForUnregisterPush;
import static com.phone.sip.SipApplication.isToAddHeadersForPushNotification;
import static com.phone.sip.constants.SipServiceConstants.DEFAULT_SIP_PORT;
...
public class SipAccountData implements Parcelable {
    ...
    AccountConfig getAccountConfig(Context appContext) {
        ...
        accountConfig.getSipConfig().getProxies().add(SipUtility.getDomainUri(appContext));
