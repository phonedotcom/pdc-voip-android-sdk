...
class BroadcastEventReceiver extends BroadcastReceiver implements SipServiceConstants {
    ...
    public void register(final Context context) {
        ...
        intentFilter.addAction(SipServiceUtils.getPrivateAction(
                BroadcastAction.REGISTRATION));
        intentFilter.addAction(SipServiceUtils.getPrivateAction(
                BroadcastAction.INCOMING_CALL));
        intentFilter.addAction(SipServiceUtils.getPrivateAction(
                BroadcastAction.CALL_STATE));
        intentFilter.addAction(SipServiceUtils.getPrivateAction(
                BroadcastAction.CALL_MEDIA_STATE));
        intentFilter.addAction(SipServiceUtils.getPrivateAction(
                BroadcastAction.OUTGOING_CALL));
        intentFilter.addAction(SipServiceUtils.getPrivateAction(
                BroadcastAction.STACK_STATUS));
        intentFilter.addAction(SipServiceUtils.getPrivateAction(
                BroadcastAction.CODEC_PRIORITIES));
        intentFilter.addAction(SipServiceUtils.getPrivateAction(
                BroadcastAction.CODEC_PRIORITIES_SET_STATUS));
        intentFilter.addAction(SipServiceUtils.getPrivateAction(
                BroadcastAction.MISSED_CALL));
        intentFilter.addAction(SipServiceUtils.getPrivateAction(
                BroadcastAction.VIDEO_SIZE));
        intentFilter.addAction(SipServiceUtils.getPrivateAction(
                BroadcastAction.CALL_STATS));
        intentFilter.addAction(SipServiceUtils.getPrivateAction(
                BroadcastAction.CALL_RECONNECTION_STATE));
        intentFilter.addAction(SipServiceUtils.getPrivateAction(
                BroadcastAction.SILENT_CALL_STATUS));
        intentFilter.addAction(SipServiceUtils.getPrivateAction(
                BroadcastAction.NOTIFY_TLS_VERIFY_STATUS_FAILED));
        intentFilter.addAction(SipServiceUtils.getPrivateAction(
                BroadcastAction.CALLBACK_SET_ACCOUNT));
        intentFilter.addAction(SipServiceUtils.getPrivateAction(
                BroadcastAction.CALLBACK_REMOVE_ACCOUNT));
        intentFilter.addAction(SipServiceUtils.getPrivateAction(
                BroadcastAction.CALLBACK_GENERIC_ERROR));
        intentFilter.addAction(SipServiceUtils.getPrivateAction(
                BroadcastAction.END_SERVICE_ACTION));
